              ...
              <div class="col-md-12">
                <div class="header-presentase d-flex align-itemx-center">
                  <div class="title-presentase">
                    <h4 class="text-primary-blue float-left">PERPUSTAKAAN</h4>
                    <p class="text-muted">
                      Peringkat perpustakaan sekolah
                    </p>
                  </div>
                  <div class="presentase-materi ml-auto">
                    {{ meta.percentageDetail }}
                  ...
                  <div class="table-presentase border mt-3 overflow-auto">
                    ...
                    >
                      ...
                      <div class="col-4 pl-0">
                        <div class="data-activity d-flex align-items-center">
                          <div class="activity-student mr-1">
                            <p>(Pinjam/tahun:{{ item.total_student }})</p>
                          </div>
                          <div class="activity-download">
                            <p>
...
export default {
  ...
  methods: {
    ...
    async loadDataPercentageDashboard() {
      ...
      self.meta.percentageDetail = null;

      await broker.fetch.get(endPoint).then((res) => {
        if (res.data.data) {
          self.meta.percentageDetail = res.data.data.percentage;
        }
      });
    },
    ...
    refreshData() {
      ...
      this.meta.data = [];
      this.meta.total = 0;
      this.meta.total_student_have_rent = 0;
      this.meta.total_student = 0;
      this.meta.percentage = "";
      this.meta.percentageDetail = "";
    },
  },
  mounted() {
    this.refreshData();

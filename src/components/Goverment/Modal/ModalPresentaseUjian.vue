      ...
      <div class="modal-dialog modal-lg ">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">PRESENTASE UJIAN</h4>
            <button
              type="button"
              class="close"
              @click="close"
              ...
              <div class="col-md-12">
                <div class="header-presentase d-flex align-itemx-center">
                  <div class="title-presentase">
                    ...
                    <p class="text-muted">
                      Peringkat ujian sekolah
                    </p>
                  </div>
                  <div class="presentase-materi ml-auto">
                    {{ meta.percentage }}
                    <span class="font-weight-bold"
                      >Nilai ujian diatas > 60</span
                    >
                  </div>
                </div>
              </div>
                      ...
                      <div class="col-4 pl-0">
                        <div class="data-activity d-flex align-items-center">
                          <div class="activity-student mr-1">
                            <p>(Nilai 60 - : {{ item.total_low_score }})</p>
                          </div>
                          <div class="activity-download">
                            <p>(Nilai 60 + : {{ item.total_high_score }})</p>
                          </div>
                          <div
...
export default {
  ...
  methods: {
    ...
    loadData() {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/government/dashboard/detail/exam-percentage`;

      ...
      <div class="modal-dialog modal-lg ">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">PRESENTASE MATERI</h4>
            <button
              type="button"
              class="close"
              @click="close"
              ...
              <div class="col-md-12">
                <div class="header-presentase d-flex align-itemx-center">
                  <div class="title-presentase">
                    <h4 class="text-primary-blue">MATERI SEKOLAH</h4>
                    <p class="text-muted">
                      Peringkat penyerapan materi per/sekolah
                    </p>
                  </div>
                  <div class="presentase-materi ml-auto">
                    {{ meta.percentage }}
                    <span class="font-weight-bold">Penyerapan materi</span>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <div class="col-md-4 pr-0">
                        <div class="p-0" style="height:25px">
                          <div
                            ...
                            role="progressbar"
                            :style="{ width: item.percentage_download }"
                            :aria-valuenow="item.percentage_download"
                            aria-valuemin="0"
                            aria-valuemax="100"
                          >
                            {{ item.school_name }}
                      ...
                      <div class="col-4 pl-0">
                        <div class="data-activity d-flex align-items-center">
                          <div class="activity-student mr-1">
                            <p>(jumlah siswa: {{ item.total_student }})</p>
                          </div>
                          <div class="activity-download">
                            <p>(diunduh: {{ item.total_theory_download }})</p>
                          </div>
                          <div
                            class="activity-presentase ml-auto text-primary-blue"
                          >
                            <p>({{ item.percentage_download }})</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/government/dashboard/detail/theory-percentage`;

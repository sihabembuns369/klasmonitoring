      ...
      <div class="modal-dialog modal-lg ">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">PRESENTASE TUGAS</h4>
            <button
              type="button"
              class="close"
              @click="close"
              ...
              <div class="col-md-12">
                <div class="header-presentase d-flex align-itemx-center">
                  <div class="title-presentase">
                    <h4 class="text-primary">TUGAS SEKOLAH</h4>
                    <p class="text-muted">
                      Peringkat tugas sekolah
                    </p>
                  </div>
                  <div class="presentase-materi ml-auto">
                    {{ meta.percentage }}
                    <span class="font-weight-bold">Pengerjaan tugas</span>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <div class="col-md-4 pr-0">
                        <div class="p-0" style="height:25px">
                          <div
                            ...
                            role="progressbar"
                            :style="{ width: item.percentage_done }"
                            :aria-valuenow="item.percentage_done"
                            aria-valuemin="0"
                            aria-valuemax="100"
                          >
                      ...
                      <div class="col-4 pl-0">
                        <div class="data-activity d-flex align-items-center">
                          <div class="activity-student mr-1">
                            <p>(jumlah tugas: {{ item.total_assignment }})</p>
                          </div>
                          <div class="activity-download">
                            <p>
                              (dikerjakan: {{ item.total_done_assignment }})
                            </p>
                          </div>
                          <div class="activity-presentase ml-auto text-primary">
                            <p>({{ item.percentage_done }})</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/government/school/${self.SchoolId}/assignment-percentage`;
      ...
      broker.fetch
        ...
        .then((res) => {
          ...
          if (res.data.meta) {
            self.meta.total_done_assignment =
              res.data.meta.total_done_assignment;
            self.meta.total_assignment = res.data.meta.total_assignment;

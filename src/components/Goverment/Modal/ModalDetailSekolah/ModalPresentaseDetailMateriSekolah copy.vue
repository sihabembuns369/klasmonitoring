      ...
      <div class="modal-dialog modal-lg ">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">PERSENTASE MATERI</h4>
            <button
              type="button"
              class="close"
              @click="close"
              ...
              <div class="col-md-12">
                <div class="header-presentase d-flex align-itemx-center">
                  <div class="title-presentase">
                    <h4 class="text-primary">PENYERAPAN MATERI</h4>
                    <p class="text-muted">
                      Peringkat materi per/mapel yang paling banyak
                      diunduh/dilihat pelajar
                    </p>
                  </div>
                  <div class="presentase-materi ml-auto">
                    {{ meta.percentage }}
                    <span class="font-weight-bold">Penyerapan pelajaran</span>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <div class="col-4 pl-0">
                        <div class="data-activity d-flex align-items-center">
                          <div class="activity-student mr-1">
                            <p>(Unduhan: {{ item.total_theory_download }})</p>
                          </div>
                          <div class="activity-download">
                            <p>(View: {{ item.total_theory_view }})</p>
                          </div>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/government/school/${self.SchoolId}/theory-percentage`;

...
<script>
import ModalDetailMapel from "../../../components/School/Modal/ModalDetailMapel";
import ModalPresentaseMapel from "../../../components/School/Modal/ModalPresentaseMapel";
...
export default {
  ...
  methods: {
    ...
    loadData(url = null) {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/school/dashboard/subject?limit=${self.limit}`;

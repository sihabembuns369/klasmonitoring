              ...
              <table class="table table-hover text-nowrap">
                ...
                <tbody v-else>
                  ...
                  >
                    ...
                    <td>{{ item.last_assignment_dates | formatDateTime }}</td>
                    <td>{{ item.total_assignment | formatNumber }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
export default {
  ...
  methods: {
    ...
    loadData(url = null) {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/school/dashboard/assignment/total-by-subject/detail?limit=${self.filter.limit}`;

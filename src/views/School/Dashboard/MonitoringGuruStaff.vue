...
<script>
import ModalBIodataGuruStaff from "../../../components/School/Modal/ModalBiodataGuruStaff";
...
export default {
  ...
  methods: {
    ...
    loadData(url = null) {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/school/dashboard/teacher?${self.limit}`;

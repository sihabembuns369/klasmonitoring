...
export default {
  metaInfo: {
    title: "Detail Persentase Posting",
  ...
  methods: {
    ...
    loadData(url = null) {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/school/dashboard/feed/percentage-by-class/detail?limit=${self.filter.limit}`;

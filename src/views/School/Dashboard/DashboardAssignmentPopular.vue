...
export default {
  metaInfo: {
    title: "Detail Mata Pelajaran Terpopuler",
  ...
  methods: {
    ...
    loadData(url = null) {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/school/dashboard/assignment/popular-by-subject/detail?limit=${self.filter.limit}`;

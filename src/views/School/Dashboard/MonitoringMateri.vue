...
<script>
import ModalDetailMateri from "../../../components/School/Modal/ModalDetailMateri";
import ModalPresentaseMateri from "../../../components/School/Modal/ModalPresentaseMateri";
...
export default {
  ...
  methods: {
    ...
    loadData(url = null) {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/school/dashboard/theory?limit=${self.limit}`;
    ...
    waitSearch() {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/school/dashboard/theory?${self.limit}`;

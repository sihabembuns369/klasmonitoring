      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="header-school d-flex align-items-center">
            ...
            <label for="sekolah" class="mt-2">Jumlah buku</label>
            <input
              id="sekolah"
              type="text"
              name="table_search"
                    ...
                    <table class="table table-hover table-information">
                      <thead class="bg-dark text-white">
                        <tr>
                          ...
                          <th scope="col">Total buku - terdaftar</th>
                          <th scope="col">Pinjam/tahun</th>
                      ...
                      <tbody v-if="!searchLoading && totalBook.length == 0">
                        <tr>
                          <td valign="top" colspan="10" class="text-center">
                      ...
                      <tbody v-else>
                        ...
                        >
                          ...
                          <td v-else>-</td>
                          <td>
                            {{ item.book_stock_total }} (
                            {{ item.school_have_this_book_total }} sekolah )
                          </td>
                          <td>{{ item.rent_total }} x</td>
                          <td>
                            <a
                              class="action-detail"
                              type="button"
...
import ModalDetailJumlahBuku from "../../../../components/Goverment/Modal/ModalDetailJumlahBuku";
export default {
  name: "Perpustakaan",
  metaInfo: {
    title: "Monitoring Jumlah Buku",
    titleTemplate: "%s | Pemerintah",
  },
  components: {
    "modal-detail-jumlahbuku": ModalDetailJumlahBuku,

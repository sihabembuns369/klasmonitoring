      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="header-school d-flex align-items-center">
            ...
            <label for="sekolah" class="mt-2">Terlambat</label>
            <input
              id="sekolah"
              type="text"
              name="table_search"
                ...
                <div class="col-md-12">
                  <div class=" table-wrapper table-responsive">
                    <table class="table table-hover table-information">
                      <thead class="bg-dark text-white">
                        <tr>
                          ...
                          <th
                            scope="col"
                            class="text-center"
                            v-column-sortable:student_late
                          >
                            Pelajar
                          </th>
                          <th
                            scope="col"
                            class="text-center"
                            v-column-sortable:teacher_late
                          >
                            Guru
                          </th>
                          <th
                      ...
                      <tbody v-if="!searchLoading && late.length == 0">
                        <tr>
                          <td valign="top" colspan="10" class="text-center">
                      ...
                      <tbody v-else>
                        ...
                        >
                          ...
                          <td class="text-center">{{ item.total_late }}</td>
...
<script>
import ModalDetailTerlambat from "../../../../components/Goverment/Modal/ModalPresensi/ModalDetailTerlambat";
...
export default {
  name: "Perpustakaan",
  components: {
    "modal-detail-terlambat": ModalDetailTerlambat,
  ...
  methods: {
    ...
    orderBy(sortFn) {
      ...
      this.late.sort(sortFn);
    },
    loadData(url = null) {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/government/klastime/detail/late?limit=${self.limit}`;

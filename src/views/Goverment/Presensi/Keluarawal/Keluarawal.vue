      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="header-school d-flex align-items-center">
            ...
            <label for="sekolah" class="mt-2">Keluar Awal</label>
            <input
              id="sekolah"
              type="text"
              name="table_search"
                    ...
                    <table class="table table-hover table-information">
                      <thead class="bg-dark text-white">
                        <tr>
                          ...
                          <th scope="col" v-column-sortable:total_early_out>
                            Keluar Awal
                          </th>
                      ...
                      <tbody v-if="!searchLoading && earlyOut.length == 0">
                        <tr>
                          <td valign="top" colspan="10" class="text-center">
...
<script>
import ModalDetailKeluarAwal from "../../../../components/Goverment/Modal/ModalPresensi/ModalDetailKeluarAwal";
...
export default {
  name: "Perpustakaan",
  components: {
    "modal-detail-keluarawal": ModalDetailKeluarAwal,
  ...
  methods: {
    ...
    orderBy(sortFn) {
      ...
      this.earlyOut.sort(sortFn);
    },
    loadData(url = null) {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/government/klastime/detail/early-out?limit=${self.limit}`;

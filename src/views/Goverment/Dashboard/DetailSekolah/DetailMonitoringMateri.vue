      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="header-school d-flex align-items-center">
            ...
            <modal-persentase-materi-detail
              ...
              <table class="table table-hover table-information">
                <thead class="bg-dark text-white">
                  <tr>
                    ...
                    <th v-column-sortable:school_subject scope="col">Mapel</th>
                    <th v-column-sortable:grade class="text-center" scope="col">
                      Grade
                    </th>
                ...
                <tbody v-if="!searchLoading && detailTheory.length == 0">
                  <tr>
                ...
                <tbody v-else>
                  <tr
                    v-for="(item, index) in detailTheory"
                    :key="`${index}-detailTheory`"
                  >
                    <td>{{ index + 1 }}</td>
...
<script>
import ModalDetailMateriSekolah from "../../../../components/Goverment/Modal/ModalDetailSekolah/ModalDetailMateriSekolah";
// import ModalPresentaseDetailMateriSekolah from "../../../../components/Goverment/Modal/ModalDetailSekolah/ModalPresentaseDetailMateriSekolah";
...
export default {
  ...
  components: {
    "modal-detail-materi-sekolah": ModalDetailMateriSekolah,
    Loading: () => import("../../../../components/Goverment/Loading"),

    // "modal-persentase-materi-detail": ModalPresentaseDetailMateriSekolah,
  },
  data() {
    return {
      modalVisible: false,
  ...
  methods: {
    ...
    orderBy(sortFn) {
      ...
      this.detailTheory.sort(sortFn);
    },
    loadData(url = null) {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/government/school/${self.$route.params.id}/theory?limit=${self.limit}`;
    ...
    waitSearch() {
      let self = this;
      let endPoint = `${process.env.VUE_APP_API_URL}/government/school/${self.$route.params.id}/theory?${self.limit}`;

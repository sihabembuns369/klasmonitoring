      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="header-school d-flex align-items-center">
            ...
            <label for="sekolah" class="mt-2">Postingan E-book</label>
            <input
              id="sekolah"
              type="text"
              name="table_search"
                ...
                <div class="header-table d-flex align-items-center">
                  <div class="information-data">
                    <b
                      ...
                      data posting e-book ditampilkan</b
                    >
                  </div>
                </div>
              </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Si Biru & Si Merah (2.5mb)</td>
                        <td>Selya Indah Puspita</td>
